...
public class Help
{
    ...
    {
        Title = "SystemPride",
        Description = "SystemPride is a bot designed for plural communities on Discord, and is open for anyone to use. It allows you to register systems, maintain system information, set up message proxying, log switches, and more.",
        Footer = new("By @Ske#6201 | Myriad by @Layl#8888 | GitHub: https://github.com/sakurascoding/SystemPride/ | Website: https://pluralkit.me/"),
        ...
        },
        {
            ...
            new Embed.Field[]
            {
                ...
                (
                    ...
                    String.Join("\n", new[]
                    {
                        "To get started using SystemPride, try running the following commands (of course replacing the relevant names with your own):",
        ...
        },
        {
            ...
            new Embed.Field[]
            {
                ...
                (
                    "More information",
                    String.Join("\n", new[] {
                        "For a full list of commands, see [the command list](https://pluralkit.me/commands), or type `sp;commands`.",
    ...
    {
        "> **About SystemPride**\nSystemPride detects messages enclosed in specific tags associated with a profile, then replaces that message under a \"pseudo-account\" of that profile using Discord webhooks.",
